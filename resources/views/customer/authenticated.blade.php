...
{{--            ></i>--}}
        ...
        <H2 style="color: white">Xin chào {!! $datas['customerInfo']->name !!}!</H2>
        <H3 style="color: white">Mã của bạn là: <span>{!! $datas['customerInfo']->giftCode !!}</span></H3>
        ...
        <div class="row mt-5">
            <div class="col-12 mb-3">
                <div class="main-button">
                    <a class="text-white" href='{!! $datas['customerInfo']->giftLink !!}'>SỬ DỤNG MÃ</a></div>
            </div>
            <div class="col-12 mb-3">
            ...
            <div class="col-12 mb-3">
                <a class="text-white" href='{{route('logout')}}'>Đăng xuất</a>
            </div>
        </div>
    </div>
</div>
